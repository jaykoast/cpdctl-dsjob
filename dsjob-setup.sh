...
cpdctl dsjob export-zip --project DataGovProject --name ds1 --file-name TESTING-EXPORT-ZIP && cpdctl dsjob import-zip --project TestingPipeline --file-name TESTING-EXPORT-ZIP
sleep 10
